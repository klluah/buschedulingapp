...
public class BusFunctions {
    ...
    public BusFunctions() {
        ...
        databaseReference = db.getReference(Bus.class.getSimpleName()).child(Placeholder.currentdate);
    }
    ...
    public Query get() { return databaseReference.orderByKey(); } // get data from db
}
